...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;">
  ...
  <tr><td style="background:#0F0D16;padding:56px 48px;text-align:center;">
    ...
    <a href="https://www.drivamor.com/upgrade" style="display:inline-block;background:#ffffff;color:#0F0D16;font-family:Arial,sans-serif;font-size:14px;font-weight:700;letter-spacing:0.04em;text-decoration:none;padding:16px 40px;border-radius:4px;">Get the full report — $34.99</a>
  </td></tr>
